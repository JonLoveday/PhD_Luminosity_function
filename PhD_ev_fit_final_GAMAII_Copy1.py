...
def ev_fit(infile, outfile, mlims=(0, 19.8), param='R_PETRO',
           ...
           lf_est='weight', area=180, kc_responses=['sdss_u0', 'sdss_g0', 'sdss_r0','sdss_i0', 'sdss_z0'], r_band_index=2):
    ...
    par.update({'infile': infile, 'mlims': mlims,
                ...
                'idebug': idebug, 'method': method, 'lf_est': lf_est, 'area': area, 'kc': kc, 'r_index': r_band_index})
...
def simcat(infile,
           ...
           Mrange=(-24, -14), mrange=(10, 19.8), zrange=(0.002, 0.65), nz=65,
           fbad=0.03, do_kcorr=True, area_fac=1.0, nblock=500000, schec_nz=0, area=180, 
           kc_responses=['sdss_u0', 'sdss_g0', 'sdss_r0','sdss_i0', 'sdss_z0'], r_band_index=2):
...
#             print(nclean, 'out of', ncand, 'targets with clean photometry')
        ...
        if mock:
            ...
            gal_arr['coeff'] = np.array(tbdata['coeff_r'].tolist())
