...
def simcat(infile,
           ...
           Mrange=(-23.5, -14), mrange=(10, 19.65), zrange=(0.001, 0.5), nz=65,
...
#        pdb.set_trace()
    ...
    while nrem > 0:
        ...
        pc_ran = pc[kidx, :]
        kc = np.array([kcorr(z[i], pc_ran[i, :]) for i in range(nsel)])
        mapp += kc
        ra = ra_gal[kidx]
    ...
    data = {
        ...
        'kcorrection': [kc_out[i] for i in samp_list],
        'pcoeffs': [pc_out[i, :] for i in samp_list],
        'A_r': A_r
    }
...
#         cols = hdulist[1].columns
        ...
        par['omega_l'] = 0.7
        par['z0'] = 0
        par['area'] = 230.6 * (math.pi/180.0)**2
